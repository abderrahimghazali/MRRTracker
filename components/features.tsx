    ...
    >
      <Header>
        <h2 className="font-sans text-bold text-xl text-center md:text-4xl w-fit mx-auto font-bold tracking-tight text-neutral-8000 dark:text-neutral-100 text-neutral-800">
          Your Revenue, Always in Sight
        </h2>
      </Header>
      <p className="max-w-lg text-sm text-neutral-600 text-center mx-auto mt-4 dark:text-neutral-400">
        Effortlessly track your Monthly Recurring Revenue (MRR) right from your macOS toolbar. Stay informed, stay in control.
      </p>
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-40">
            <CardTitle>Real-Time MRR Updates</CardTitle>
            <CardDescription>
              Keep your finger on the pulse of your business with instant MRR updates displayed directly in your macOS toolbar.
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            <CardTitle>Milestone Notifications</CardTitle>
            <CardDescription>
              Celebrate key milestones with automatic notifications as your business reaches new revenue targets.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
              MRRTracker is designed for simplicity—no clutter, just your essential revenue data presented clearly and beautifully.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-40">
            <CardTitle>Lightweight and Efficient</CardTitle>
            <CardDescription>
              Minimal system impact, MRRTracker quietly runs in the background while you focus on growing your business.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
