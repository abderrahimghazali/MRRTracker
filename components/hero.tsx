...
export function Hero() {
  ...
  return (
    <div
      ref={parentRef}
      className="relative z-0 flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-20 md:px-8 md:py-40 bg-neutral-50 dark:bg-neutral-900"
    >
      <BackgroundGrids />
      <CollisionMechanism
        beamOptions={{
      ...
      >
        Track your MRR from your toolbar, stay updated on growth, and get milestone notifications—hassle-free.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
